...
BasicGame.Boot.prototype = {
    ...
    preload: function () {
        ...
        this.load.image('preloaderBar', 'images/preloader/loading_bar.png');
        this.load.image('imagening', 'images/preloader/imagening.png');
    ...
    create: function () {
        ...
        {
            this.game.stage.scaleMode = Phaser.StageScaleMode.SHOW_ALL;
            // this.game.stage.scaleMode.forcePortrait = true;
